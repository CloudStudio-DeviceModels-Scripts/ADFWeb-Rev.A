...
# Configuration Script – ADFWeb - Rev. A

This **Configuration** script is designed for the **ADFWeb** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – ADFWeb Rev. A

Este script de **Configuration** está diseñado para el modelo **ADFWeb** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
